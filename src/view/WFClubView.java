...
public class WFClubView {
    ...
    private static final String[] fitLessons = {
        "Spin",
        "Yoga",
        "Bodysculpt",
        "Zumba",
    ...
    private static final String[] fitLessonsFees = {
        "30",
        "20",
        "25",
        "15",
    ...
    public WFClubView() {
        ...
        while (choice != 99) {
            ...
            System.out.println("6. Highest income report");
            ...
            case 7:
                ...
                System.out.print("Enter the week (1-4): ");
    ...
    public boolean bookLesson() {
        ...
        System.out.print("Enter the week for booking(1-4): ");
		...
		if (customers.contains(customerId)) {
			...
			if (newDay.equals("Saturday")) {
				if (weekend.equals("1"))
					newLessons = satFirst;
				if (weekend.equals("2"))
					newLessons = satSecond;
				if (weekend.equals("3"))
					newLessons = satThird;
				if (weekend.equals("4"))
					newLessons = satFourth;

			} else if (newDay.equals("Sunday")) {
				if (weekend.equals("1"))
					newLessons = sunFirst;
				if (weekend.equals("2"))
					newLessons = sunSecond;
				if (weekend.equals("3"))
					newLessons = sunThird;
				if (weekend.equals("4"))
					newLessons = sunFourth;
    ...
    public boolean cancelBooking() {
        ...
        System.out.print("Enter the day (Saturday or Sunday): ");
        String day = bookScanner.nextLine();
        System.out.print("Enter the week you booked for cancelling(1-4): ");
        String weekend = bookScanner.nextLine();
        System.out.print("Enter the lesson type: ");
        String lessonType = bookScanner.nextLine();
        System.out.print("Enter your customer ID: ");
    ...
    private void review() {
        ...
        for (String customerId: reviewsByCustomer.keySet()) {
            ...
            for (int i = 0; i < reviews.size(); i++) {
                ...
                System.out.println("  Rating: " + getMessages(rating));
                System.out.println("-----------------------------");
            }
        }
    }

    private String getMessages(int rating) {
        switch (rating) {
        case 1:
